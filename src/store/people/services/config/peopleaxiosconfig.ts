...
import { logout } from '../../../master/slices/authSlice';
...
const apiPeopleClient = axios.create({
...
apiPeopleClient.interceptors.request.use((config: any) => {
...
apiPeopleClient.interceptors.response.use(
...
export default apiPeopleClient;