...
import {
    Box, Button, Card, CardContent, CardMedia, Chip, Divider, Pagination, Stack, Typography,
} from "@mui/material";
...
const Blogs: React.FC<any> = ({ onClose }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const res = await DynamicScreenService.getCaseStudiesList();
    ...
    const chipLabels = useMemo(() => {
        const uniqueTypes = Array.from(new Set(articles.flatMap((p: any) => p.tags)));
